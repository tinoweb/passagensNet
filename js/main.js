...
$(document).ready(function() {
	 ...
	 $('#simulaPassageForm').submit(function(event) {
     	event.preventDefault();
     	...
     	var passAdulto 	= $('#passAdulto').val();
     	var passCrianca = $('#passCrianca').val();
     	var passBebe    = $('#passBebe').val();
	    ...
	    $.ajax({
	     	...
	     	data: {
	     		...
	     		'origem': origem,
	     		'destino': destino,
	     		'passAdulto': passAdulto,
	     		'passCrianca': passCrianca,
	     		'passBebe': passBebe,
	     		'dataIda': dataida,
